	...
	cases := []struct {
		...
		{name: "listSets",
			...
			expectCost: map[string]int64{
				...
				"sets.contains(self.val1, ['a'])":                3,
				"sets.equivalent(self.val1, ['a', 'b', 'c'])":    3,
				"sets.intersects(self.val1, ['a'])":              3,
				"sets.contains(self.val3, [1])":                  3,
				"!sets.equivalent(self.val3, [1, 2, 3])":         4,
				"sets.intersects(self.val3, [1])":                3,
			},
		},
		{name: "listMaps",
			obj: map[string]interface{}{
